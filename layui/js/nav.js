...
layui.define(["element","jquery"],function(exports){
	...
	Tab.prototype.render = function() {
		...
		//显示左侧菜单
		var _this = this;
		$(".navBar ul").html('<li class="layui-nav-item layui-this"><a href="javascript:;" data-url="page/main.html"><i class="layui-icon" data-icon=""></i><cite>首页</cite></a></li>').append(_this.navBar(dataStr)).height($(window).height()-60);
	...
	$("body").on("click",".top_tab li i.layui-tab-close",function(){
		...
		element.tabDelete("nav",$(this).parent("li").attr("lay-id")).init();
		nav.tabMove();
	})
		...
		if($("#top_tabs li").length>2 && $("#top_tabs li.layui-this cite").text()!="首页"){
			...
			$("#top_tabs li").each(function(){
				if($(this).attr("lay-id") != '' && !$(this).hasClass("layui-this")){
					element.tabDelete("nav",$(this).attr("lay-id")).init();
