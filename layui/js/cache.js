...
layui.use(['form','jquery',"layer"],function() {
    ...
    function showNotice(){
        layer.open({
            ...
            btn: ['确认'],
            moveType: 1,
            content: '<div style="padding:15px 20px; text-align:justify; line-height: 22px; text-indent:2em;border-bottom:1px solid #e2e2e2;"><p class="layui-red">用人单位：福州福美德清洁服务有限公司：2018年6月4日，福州福美德清洁服务有限公司向我局提出庞现玉工伤认定申请，主诉：庞现玉为福州福美德清洁服务有限公司职工，2017年6月17日，庞现玉从合肥万达威斯汀酒店下班，途径明光路和平盛世附近时，不慎遭受本人无责的交通事故伤害，致：右髌骨骨折。申请人向我局申请工伤认定，并向我局出具了工伤认定申请表、医疗机构诊断证明等相关证据材料。</p></pclass></p><p>根据《工伤保险条例》第十九条和《安徽省实施〈工伤保险条例〉办法》第十七条的规定，若你公司对申请人的申请事由有异议，请自收到本举证通知书之日起15日内将书面反馈意见及举证材料报我局，逾期不举证和答复，我局将采信申请人提供的证据做出行政决定。反馈意见材料请附你公司联系人、联系方式。</p></div>',
    ...
    function lockPage(){
        layer.open({
            ...
            content : '<div class="admin-header-lock" id="lock-box">'+
                            '<div class="admin-header-lock-img"><img src="images/userface4.jpg" class="userAvatar"/></div>'+
            ...
            content :  '<div class="functionSrtting_box">'+
                            '<form class="layui-form">'+
                                ...
                                '<div class="layui-form-item skinBtn">'+
                                    '<a href="javascript:;" class="layui-btn layui-btn-sm layui-btn-normal" lay-submit="" lay-filter="settingSuccess">确认设定</a>'+
